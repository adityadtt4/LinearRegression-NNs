...
- The task involved using the Scikit-learn library and training a linear regression and multi layer perceptron regression model offered in order to try to predict the value of Premier League footballers based on their performance in the 2024/25 season
